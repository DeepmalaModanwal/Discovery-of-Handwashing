...
yearly =yearly = pd.read_csv('datasets/yearly_deaths_by_clinic.csv')
...
```
    ...
    <ipython-input-43-c42de52ddb0a> in <module>()
          3 
          4 # Read datasets/yearly_deaths_by_clinic.csv into yearly
    ----> 5 yearly =yearly = pd.read_csv('datasets/yearly_deaths_by_clinic.csv')
          6 
          7 # Print out yearly
...
monthly = monthly = pd.read_csv('datasets/monthly_deaths.csv',parse_dates=['date'])
